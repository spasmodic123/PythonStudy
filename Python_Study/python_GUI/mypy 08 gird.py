...
class Application(Frame):  # Application也是一个组件
    ...
    def createWidget(self):
        ...
        Label(self,text="用户名为名字拼音").grid(row=1,column=2)
        '''密码'''
        ...
        self.btn01.grid(row=3,column=1,sticky="ew")

        Button(self,text="退出登录",command=root.destroy).grid(row=3,column=2,sticky="ns")
